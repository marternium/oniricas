...
const albumsData = [
...

  {
    ...
    songs: [
      ...
      "Le Chuko - La Perluca Nunca Atraca",
      "Judini - El Truco Final",
      "Dragocerdo - Donde Rugen los Porcos",
      "Trankitronko - Humo de Kalipto",
      "Maxilubo - El Alfa",
      "Moon - El Rey de la Jungla Está Loco",
      "Señor de las Marionetas - El Último Acto",
      "Malefíscof - Todo Tiene un Precio",
